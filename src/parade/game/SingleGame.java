 ...
 * 
 * <p>
 * It integrates deck usage, parade updates, and player interactions, including
...
public class SingleGame {
    ...
    /**
     * Constructs a new {@code SingleGame} session and deals initial cards to all
     * players.
     *
    ...
    public ArrayList<Player> run() {
        while (playerList.getPlayer(turn).getHandSize() == 5) {
            ...
            try {
                ...
                String reset = "\u001B[0m";
                System.out.println(
                        "Parade: " + par.getParade() + " \u001B[36m<== " + bold + "Card inserted here" + reset);
